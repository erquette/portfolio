...
export const PROJECTS: Project[] = [
  {
    ...
    year: "2026",
    status: "IP",
    description: "I recently found out the scanning app I had been using was storing data on their servers. Privacy when scanning personal documents shouldn't be an afterthought, so I built something where nothing leaves your device. It also gave me an excuse to get into computer vision, playing around with edge detection, perspective warping, and all that cool stuff.",
    tech: ["React", "TypeScript", "OpenCV.js"],
  },
  {
    title: "Azure DSN",
    year: "2024",
    description: "As part of a course project, I led a team of six building a distributed social network inspired by Mastodon. The project itself spans about 2-3 months, and somewhere between wrangling the Django backend and keeping everyone moving in the same direction, I actually started to get how the web works.",
